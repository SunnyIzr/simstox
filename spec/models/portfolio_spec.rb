...
describe Portfolio do
  ...
  let!(:trades) { [ 
    FactoryGirl.create(:trade, ticker: 'msft', quantity: 10, price_cents: 30_00, portfolio_id: portfolio_id), 
    FactoryGirl.create(:trade, ticker: 'msft', quantity: 20, price_cents: 50_00, portfolio_id: portfolio_id), 
    FactoryGirl.create(:trade, ticker: 't', quantity: 15, price_cents: 40_00, portfolio_id: portfolio_id), 
    FactoryGirl.create(:trade, ticker: 'msft', quantity: -17, price_cents: 35_00, portfolio_id: portfolio_id),
    FactoryGirl.create(:trade, ticker: 'ko', quantity: 30, price_cents: 25_00, portfolio_id: portfolio_id)
  ]}
